...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("-");
        System.out.println("Conteudos inscritos Michael" + devMichael.getConteudosInscritos());
        System.out.println("Conteudos Concluidos Michael" + devMichael.getContudosConcluidos());
        ...
        System.out.println("-");
        System.out.println("Conteudos inscritos Camila" + devCamila.getConteudosInscritos());
        System.out.println("Conteudos Conscluidos Camila" + devCamila.getContudosConcluidos());
